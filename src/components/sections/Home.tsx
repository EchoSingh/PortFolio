      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className={`text-xl md:text-2xl ${theme === 'dark' ? 'text-gray-400' : 'text-navy-600'}`}>
            <TypeWriter words={["Software Developer.", "Mobile App Developer.", "Machine Learning."]} />
          </div>

          <p className={`text-lg leading-relaxed ${theme === 'dark' ? 'text-gray-300' : 'text-navy-700'}`}>
            Passionate about solving complex problems through data structures and algorithms, exploring machine learning, and continuously improving my skills in programming.
            A chess enthusiast, I enjoy strategic thinking and problem-solving, both on the board and in my coding projects.
            Let's collaborate to build innovative solutions and tackle challenges together.
          </p>
        ...
        <div className="flex justify-center">
          <div className="relative w-64 h-64 group">
            ...
            <div className="relative rounded-full overflow-hidden transform hover:scale-105 transition-transform duration-300">
              <img
                src="https://media.licdn.com/dms/image/v2/D4D03AQH2JGbsF4X3Pg/profile-displayphoto-shrink_800_800/B4DZY6EVeLHsAc-/0/1744730938190?e=1756339200&v=beta&t=koSOhgcEmYiWjA2OfRopxizc28CI3F0ervnQFnyQrVM"
                alt="Aditya Singh"
